...
<div id="background" class="relative w-full">
    <div class="absolute w-full h-[300px] bg-[linear-gradient(0deg,#4EB5F5-0%,#5B8CE9_100%)] -z-10"></div>
</div>
    ...
    <div class="flex flex-col gap-16">
        <div class="flex flex-col items-center gap-1">
            ...
            <div class="flex items-center gap-2 text-white">
                <a class="last:font-semibold" href="#">Homepage</a>
                <span>/</span>
                <a class="last:font-semibold" href="#">Workshop Details</a>
                <span>/</span>
                <a class="last:font-semibold" href="#">Booking Workshop</a>
            </div>
        </div>
    </div>
</section>
...
<section id="Content" class="w-full max-w-[1280px] mx-auto px-[52px] mt-16 mb-[100px]">
    <div class="flex flex-col gap-16">
        ...
        <main class="flex gap-8">
            ...
            <form id="Form"  method="POST"  action="{{route('front.booking.store', $workshop->slug)}}" class="flex flex-col w-[724px] gap-8">
                @csrf
...
<script src="{{asset('js/accoding.js')}}"></script>
